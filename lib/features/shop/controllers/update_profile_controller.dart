...
class UpdateProfileController extends GetxController {
  ...
  final firstName =
      TextEditingController(text: UserController.instance.user.value.firstName);
  final lastName =
      TextEditingController(text: UserController.instance.user.value.lastName);
  final username =
      TextEditingController(text: UserController.instance.user.value.userName);
  ...
  Future<void> updateUserData(UserModel userModel) async {
    ...
    ECFullScreenLoader.stopLoading(); // stops the loading
    update(); // rebuildes the ui when called
  }
}
