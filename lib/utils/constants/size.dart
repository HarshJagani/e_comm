...
class ECSize {
  ...
  //Font sizes
  static double fontSm = 14;
  static double fontMd = 16;
  static double fontLg = 18;
  ...
  static double spaceBtwItems = 24;
  static double spaceBtwSections = 24;
  ...
  static double productItemHeight = 160;

  //Input field
  static double inputFieldRadius = 12;
  static double spaceBtwFields = 16;
  ...
  static double imageCarouseHeight = 200;
